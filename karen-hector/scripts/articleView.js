...
articleView.handleAuthorFilter = function() {
  $('#author-filter').on('change', function() {
    ...
    // let $authorSelected = $(this).data('#author-filter');
    if ($(this).val()) {
...
articleView.handleCategoryFilter = function() {
  // TODO-ne: Just like we do for #author-filter above, we should handle change events on the #category-filter element.
